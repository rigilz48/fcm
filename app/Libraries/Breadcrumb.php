...
class Breadcrumb
{
    ...
    public function __construct()
    {
        ...
        $this->tags['divopen']  = "<div class=\"container\">";
        $this->tags['divclose'] = "</div>";
        $this->tags['olopen']   = "<ol>";
        $this->tags['olclose']  = "</ol>";
        $this->tags['liopen']   = "<li class=\"breadcrumb-item active\">";
